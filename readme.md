...
# 🛠️ Ominaisuudet
- Tapahtumien selaus
 - Kategoriat: musiikki/urheilu
- Lipunosto
 - Varastosaldon ylläpito
- Käyttäjätilin luonti ja hallinta
  - Salasanan vaihto
  - Ylläpitosivu
   - Tapahtuman lisäys
...
# 🔐 Tietoturva
- Salasanankäsittely
- SQL- tulostuksen suojaus (htmlspecialchars)
- Istuntomuuttujan päivitys ja vanhan poisto

#🐞⭐ Tunnetut ongelmat ja kehitysideat
